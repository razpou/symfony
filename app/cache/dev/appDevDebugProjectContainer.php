...
class appDevDebugProjectContainer extends Container
{
     ...
     * This method always returns the same instance of the service.
     *
     * @return EntityManager511cac54a75ba_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EntityManager511cac54a75ba_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once 'C:/wamp/www/symfony/app/cache/dev/jms_diextra/doctrine/EntityManager_511cac54a75ba.php';

        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_f4db1d2bcae9f8d4de75c4b97f91c6f5');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_f4db1d2bcae9f8d4de75c4b97f91c6f5');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_f4db1d2bcae9f8d4de75c4b97f91c6f5');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => 'C:\\wamp\\www\\symfony\\src\\Blog\\BlogBundle\\Entity')), 'Blog\\BlogBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('BlogBundle' => 'Blog\\BlogBundle\\Entity'));
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager511cac54a75ba_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($f, $this);
    }
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), '45ad10412816322c587c9077cf2937cb567a46e9');
    }
     ...
     *
     * @return EntityManager511cac54a75ba_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager An instance of the doctrine.orm.default_entity_manager service
     */
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'BlogBundle' => 'Blog\\BlogBundle\\BlogBundle',
            ...
            'locale' => 'en',
            'secret' => '45ad10412816322c587c9077cf2937cb567a46e9',
            'database_path' => NULL,
            ...
            'kernel.secret' => '45ad10412816322c587c9077cf2937cb567a46e9',
            ...
            'jms_di_extra.doctrine_integration.entity_manager.file' => 'C:/wamp/www/symfony/app/cache/dev/jms_diextra/doctrine/EntityManager_511cac54a75ba.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager511cac54a75ba_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
